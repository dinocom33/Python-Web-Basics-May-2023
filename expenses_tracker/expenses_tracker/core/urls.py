...
from expenses_tracker.core.views import index, create_profile
from .views import create_expense, edit_expense, delete_expense, show_profile, edit_profile, delete_profile
