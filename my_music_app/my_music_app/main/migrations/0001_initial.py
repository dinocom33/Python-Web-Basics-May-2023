...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=15, validators=[django.core.validators.MinValueValidator(2), my_music_app.main.validators.validate_only_alphanumeric])),
                ('email', models.EmailField(max_length=254)),
                ('aget', models.PositiveIntegerField(blank=True, null=True)),
            ],
        ),
    ]
